...
app = Flask(__name__)
domainName = 'linuxeasy'

app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///' + os.path.join(basedir, 'linuxeasy.sqlite')
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.secret_key = 'super secret key'

with open('/home/linuxeasy/mysite/templates/config.json', 'r') as c:
